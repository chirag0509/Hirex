...
class RecruiterDetailForAdmin extends StatefulWidget {
  final RecruiterModel user;
  RecruiterDetailForAdmin({Key? key, required this.user}) : super(key: key);

  @override
  State<RecruiterDetailForAdmin> createState() =>
      _RecruiterDetailForAdminState();
}

class _RecruiterDetailForAdminState extends State<RecruiterDetailForAdmin> {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "● Company : " + widget.user.company.capitalize.toString(),
                  style: TextStyle(
                      fontSize: w * 0.045,
                      fontWeight: FontWeight.w500,
                      color: darkMode ? whiteColor : blackColor),
                ...
                Text(
                  "● Vacacny : " + widget.user.vacancy.capitalize.toString(),
                  style: TextStyle(
                      fontSize: w * 0.045,
                      fontWeight: FontWeight.w500,
                      color: darkMode ? whiteColor : blackColor),
